#
#  Be sure to run `pod spec lint SocialGIST.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SocialGIST"
  s.version      = "1.0"
  s.summary      = "SocialGIST is the social layour of GISTFramework."
  ...
  s.description  = <<-DESC
                   SocialGIST is the social layour of GISTFramework. it is made on top of GISTFramework.
                   DESC

  s.homepage     = "https://github.com/cubixlabs/SocialGIST"
  ...
  s.source       = { :git => "https://github.com/cubixlabs/SocialGIST.git", :tag => "1.0" }
  ...
  #s.source_files  = "SocialGIST", "SocialGIST/Classes/**/*.{swift}"
  #s.exclude_files = "SocialGIST/Exclude"

  #s.public_header_files = "SocialGIST/**/*.h"
